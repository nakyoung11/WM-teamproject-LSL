...
public class WorkDAO {
	...
	public static int insWork(WorkVO param) {
		String sql = " INSERT INTO t_work " + " (i_user, i_show, work_images, work_title, work_ctnt) " + " VALUES "
				+ " (?, ?, ?, ?, ?) ";
	...
	// 특정 사용자가 마지막에 등록한 작품을 가져오는 메소드
	public static WorkVO selLatestWork(WorkVO param) {
		String sql = " SELECT " + " MAX(i_work) as i_work " + " FROM t_work " + " WHERE i_user = ? ";
	...
	public static List<WorkVO> selWorkList(WorkVO param) {
		String sql = " SELECT i_work, i_user, work_title, work_images, work_ctnt, i_show" + " FROM t_work ";
	...
	public static WorkVO selWork(WorkVO param) {
		String sql = " SELECT i_work, i_user, work_title, work_images, work_ctnt" + " FROM t_work ";
	...
	public static WorkDomain selWorklikeCnt(WorkVO param) {
		...
		String sql = " SELECT COUNT(i_user) as like_cnt " + " FROM t_work_like " + " WHERE i_work = ? ";
	...
	public static WorkDomain selWorkCmtCnt(WorkVO param) {
		...
		String sql = " SELECT COUNT(i_work_cmt) as cmt_cnt" + " FROM t_work_cmt " + " WHERE i_work = ? ";
	...
	public static int updWork(WorkVO param) {
		String sql = " UPDATE t_work " + " SET " + " work_title = ?, " + " work_ctnt = ?, ";
		if (param.getWork_image() != null) {
			sql += " work_images = ?, ";
		}

		sql += " m_dt = NOW() " + " WHERE i_work = ? ";
	...
	public static int delWork(WorkVO param) {
		String sql = " DELETE " + " FROM t_work " + " WHERE i_work = ? AND i_user = ?";
